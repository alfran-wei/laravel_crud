                ...
                <div class="col-xl-4 col-md-6 col-sm-12 col-12">
                    <div class="form-group">
                        ...
                        <div class="form-custom">
                            <input class="form-control" type="text" placeholder="Entrez le nom">
                        </div>
                        <button type="submit" class="btn w-100 btn-primary">Appliquer</button>
                        <button type="reset" class="btn w-100 btn-grey">Réinitialiser</button>
                    </div>
                </div>
            </div>
        </div>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\alfra\OneDrive\Documents\tp1_outils_web\preskool\resources\views/add_invoices.blade.php ENDPATH**/ ?>